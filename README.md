...
Errors are structured tuples: `{:error, {:constraint_violation, :constraint_unique, %{table: ..., columns: [...], ...}}}`, `{:error, {:read_only_database, code, message}}`, etc. 74 typed reason variants, including twelve SQLite constraint subtypes plus a generic fallback.
